...
set_param(beam_h,...
    ...
    'rho_cust','shabanaCrankshaft.mat.rho',...
    'youngsM_cust','shabanaCrankshaft.mat.E',...
    'shearM_cust','shabanaCrankshaft.mat.G',...
    'edf_beam','3.38e-05',...
    'popup_xc','Hollow Rectangle',...
    'beam_width','shabanaCrankshaft.cs.b',...
    'beam_width_in','0',...
    'beam_height','shabanaCrankshaft.cs.a',...
    'beam_height_in','0',...
    'beam_length','shabanaCrankshaft.L');
...
beam_h = [bdroot '/Flexible Beam'];
set_param(beam_h,...
    'splitBodyProps','shabanaCrankshaft.splitBodyProps(3).props',...
    'rigid_body_filename','''ShabanaConnectingRod.stl''',...
    'T','shabanaCrankshaft.models(7).T',...
    'K','shabanaCrankshaft.models(7).K',...
    'M','shabanaCrankshaft.models(7).M',...
    'ksi','0.05',...
    'dofIdxMap','shabanaCrankshaft.models(7).dofIdxMap',...
    'H','shabanaCrankshaft.models(7).H');
...
if ~exist('h10_sm_flex_fe_import_beam', 'var') || ...
        ~isgraphics(h10_sm_flex_fe_import_beam, 'figure')
    h10_sm_flex_fe_import_beam = figure('Name', 'sm_flex_fe_import_beam');
end
figure(h10_sm_flex_fe_import_beam)
clf(h10_sm_flex_fe_import_beam)
