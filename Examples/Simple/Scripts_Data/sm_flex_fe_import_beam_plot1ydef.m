...
if ~exist('h1_sm_flex_fe_import_beam', 'var') || ...
        ~isgraphics(h1_sm_flex_fe_import_beam, 'figure')
    h1_sm_flex_fe_import_beam = figure('Name', 'sm_flex_fe_import_beam');
end
figure(h1_sm_flex_fe_import_beam)
clf(h1_sm_flex_fe_import_beam)

temp_colororder = get(gca,'defaultAxesColorOrder');

% Get simulation results
simlog_dxyz = logsout_sm_flex_fe_import_beam.get('dxyz');
